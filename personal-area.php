        ...
        <div class="row">
            <div class="col-lg-4 col-md-5 pr-5">
                <ul class="nav nav-tabs tabs-left" role="tablist">
                    ...
                    <!--    bonus          -->
                    <li role="presentation" class="bonus">
                        <a href="#bonus" aria-controls="bonus" role="tab" data-toggle="tab">
                            <div class="personal_area_div">
                                <i class="fas fa-gift"></i>
                                <span>bonus cupons</span>
                            </div>
                        </a>
                    </li>
            ...
            <div class="col-lg-8 col-md-7">
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="most_important">
                        <div class="row mx-0 bonus_cart">
                            ...
                            <div class="col-6 text_right_btn">
                                <a href="#" class="bonus_cart_map">map</a>
                            </div>
                        </div>
                    ...
                    <!--password-->
                    <div role="tabpanel" class="tab-pane" id="password">password</div>
                    <!--envelope-->
                    <div role="tabpanel" class="tab-pane" id="envelope">envelope</div>
                    <!--promocode-->
                    <div role="tabpanel" class="tab-pane" id="promocode">promocode</div>
                    <!--bonus-->
                    <div role="tabpanel" class="tab-pane" id="bonus">bonus</div>
                    <!--cupons-->
                    <div role="tabpanel" class="tab-pane" id="cupons">cupons</div>
                    <!--map-->
