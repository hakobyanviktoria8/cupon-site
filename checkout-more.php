    ...
    <div class="checkout my-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12  checkout_right">
                ...
                <hr>
                <div class="checkout_right_send">
                     <div class="row my-3">
                        <div class="col-lg-3 col-md-3 col-sm-12 text-uppercase font_15">Lorem</div>
                        <div class="col-lg-9 col-md-9 col-sm-12 text_right">
                            <input type="text" class="pay_bonus" placeholder="Pay bonus">
                        </div>
                     </div>
                      <div class="row my-3">
                         <div class="col-lg-3 col-md-3 col-sm-12 text-uppercase font_15">Lorem more</div>
                         <div class="col-lg-9 col-md-9 col-sm-12 text_right">
                             <input type="text" class="pay_bonus" placeholder="Pay bonus">
                         </div>
                      </div>
                      <div class="row my-3">
                        <div class="col-lg-3 col-md-3 col-sm-12 text-uppercase font_15">E-mail</div>
                        <div class="col-lg-9 col-md-9 col-sm-12 text_right">
                            <input type="text" class="pay_bonus" placeholder="E-mail">
                        </div>
                     </div>
                      <div class="row my-3">
                         <div class="col-lg-3 col-md-3 col-sm-12 text-uppercase font_15">message</div>
                         <div class="col-lg-9 col-md-9 col-sm-12 text_right">
                            <textarea rows="4" cols="50" placeholder="Message" class="pay_bonus"></textarea>
                         </div>
                      </div>
                </div>
                <div class="row my-3">
